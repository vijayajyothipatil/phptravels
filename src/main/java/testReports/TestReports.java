		...
		public static void startTesting(String filename,String testStartTime,String env,String rel)
		  {
			...
			currentDir = indexResultFilename.substring(0,indexResultFilename.lastIndexOf("TestReport")+10);
	        ...
	        String RUN_DATE = TestUtil.now("MMM.dd.yyyy").toString();
		...
		public static void addTestCase(String testCaseName,String testCaseStartTime,String testCaseEndTime,String status){
			...
			try {
			   ...
			   if(status.equalsIgnoreCase("Skipped") || status.equalsIgnoreCase("Skip")){
				...
				File f = new File(currentDir+"\\"+currentSuiteName+"_"+testCaseName.replaceAll(" ", "_")+"_"+TestUtil.year+"_"+TestUtil.date+"_"+(TestUtil.month+1)+"_"+TestUtil.day+"_"+TestUtil.min+"_" +TestUtil.sec+".html");
				   //File f = new File("http://172.17.98.13/"+currentSuiteName+"_TC"+tcid+"_"+testCaseName.replaceAll(" ", "_")+".html");
				    f.createNewFile();
					fstream = new FileWriter(currentDir+"\\"+currentSuiteName+"_"+testCaseName.replaceAll(" ", "_")+"_"+TestUtil.year+"_"+TestUtil.date+"_"+(TestUtil.month+1)+"_"+TestUtil.day+"_"+TestUtil.min+"_" +TestUtil.sec+".html");
				...
				out.write("<h4> <FONT COLOR=660000 FACE=Arial SIZE=4.5> Detailed Report :</h4>");
			 	 ...
			 	 if(keyword!=null){
			 		 for(int i=0;i<keyword.size();i++){
			 			 ...
			 			 out.write("<td align=center width=10%><FONT COLOR=black FACE=Arial SIZE=2><b>"+keyword.get(i)+"</b></td>");
				...
				// out.newLine();
			     ...
			     if(status.equalsIgnoreCase("Skipped") || status.equalsIgnoreCase("Skip"))
			    	...
			    	// out.write("<td width=40% align= center ><FONT COLOR=black FACE= Arial  SIZE=2><b><a href=file:///"+currentDir+"//"+currentSuiteName+"_TC"+tcid+"_"+testCaseName.replaceAll(" ", "_")+DriverScript.year+"_"+DriverScript.date+"_"+(DriverScript.month+1)+"_"+DriverScript.day+"_"+DriverScript.min+"_" +DriverScript.sec+".html>"+testCaseName+"</a></b></td>\n");
			    	 out.write("<td width=40% align= center ><FONT COLOR=black FACE= Arial  SIZE=2><b><a href=file:///"+currentDir+"\\"+currentSuiteName+"_"+testCaseName.replaceAll(" ", "_")+"_"+TestUtil.year+"_"+TestUtil.date+"_"+(TestUtil.month+1)+"_"+TestUtil.day+"_"+TestUtil.min+"_" +TestUtil.sec+".html>"+testCaseName+"</a></b></td>\n");
